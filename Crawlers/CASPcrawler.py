...
# Written by Shikai Jin on 2018-Jun-3, latest modified on 2018-Jun-6
...
def get_HTML_content(url):
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'} # Add header
...
def get_namelist(content):
    namelist = []
    print ("The list of regular protein in CASP13 is ")
...
def main():
    parser = argparse.ArgumentParser(
        description="This script submits CASP13 regular targets of selected day to RaptorX-contact automatically")
